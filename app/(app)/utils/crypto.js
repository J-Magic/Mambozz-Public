...
const nonceArray = new Uint8Array(box.nonceLength);
const newNonce = () => Crypto.getRandomValues(nonceArray);
...
export const getMySecretKey = async () => {
  ...
  if (!keyString) {
    Alert.alert(
      'Reset your keypair ',
      'Go to settings and generate a new keypair. This ensures your messages are encrypted abd can only be read by users you send them to.',
      [
        {
          text: 'Go to Settings',
